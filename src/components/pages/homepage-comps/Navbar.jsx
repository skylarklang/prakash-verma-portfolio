...
const Navbar = () => {
    ...
    return (
        <header className={`fixed top-0 bg-neutral-900/60 flex bg-danger justify-between h-20 items-center py-4 px-4 md:px-6 text-white mx-auto lg:px-24 md:py-0 w-full z-30 transition-colors duration-700 ${isScrolled ? 'bg-black/100' : ''}`}>
